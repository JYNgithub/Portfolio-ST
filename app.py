...
with st.container():
    ...
    with intro:
        ...
        st.markdown('''
                    <p class="paragraph">
                    If you're here, then it means that my LinkedIn Profile caught ur attention, or my resume somehow made it pass the AI evaluation. Anyhow,  welcome to my portfolio.   
